...
int main(int argc, const char* argv[])
{
    ...
    load_images("../data/svm/j", img_test_arti);
    ...
    load_images("../data/svm/s", img_test_natu);
    ...
    load_images("../data/svm/j_test", img_eva_jinkou);
    ...
    load_images("../data/svm/s_test", img_eva_sizen);
